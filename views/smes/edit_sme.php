    ...
    <div class="activity max-width-600">
        <form action="/cultureconnect/smes/update" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="business_name" value="<?php echo htmlspecialchars($sme['business_name']); ?>" required>
            </div>
            <div class="form-group">
                <label>Contact Email</label>
                <input type="email" name="contact_email" value="<?php echo htmlspecialchars($sme['contact_email']); ?>" required>
            </div>
            <div class="form-group">
                <label>Phone</label>
                <input type="text" name="phone" value="<?php echo htmlspecialchars($sme['phone']); ?>">
            </div>
            <div class="form-group">
                <label>Portfolio Link</label>
                <input type="url" name="portfolio_link" value="<?php echo htmlspecialchars($sme['portfolio_link']); ?>">
            </div>
